/*
  ...
  - You are about to drop the column `followers` on the `Store` table. All the data in the column will be lost.
  - You are about to drop the column `followedStores` on the `User` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "Store" DROP COLUMN "followers";

-- AlterTable
ALTER TABLE "User" DROP COLUMN "followedStores";
